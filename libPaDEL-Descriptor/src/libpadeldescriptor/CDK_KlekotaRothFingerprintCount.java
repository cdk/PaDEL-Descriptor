 ...
 * Count of 4860 substructures
 * 
 * @author yapchunwei
 */
public class CDK_KlekotaRothFingerprintCount extends CDK_FingerprintCount
{
    public CDK_KlekotaRothFingerprintCount()
    {
        super();
        cdkDescriptor_ = new SubstructureFingerprintCount(smarts);

        String[] names = new String[smarts.length];
        for (int i=0; i<names.length; ++i)
        {
            names[i] = "KRFPC" + Integer.toString(i+1);
        }
