...
public class PaDELIteratingSMILESReader extends DefaultIteratingChemObjectReader {
    ...
    private static ILoggingTool logger =
        LoggingToolFactory.createLoggingTool(PaDELIteratingSMILESReader.class);
    ...
    /**
     * Constructs a new PaDELIteratingSMILESReader that can read Molecule from a given InputStream.
     *
    ...
    /**
     * Constructs a new PaDELIteratingSMILESReader that can read Molecule from a given InputStream and IChemObjectBuilder.
     *
     * @param in      The input stream
     * @param builder The builder
     */
    public PaDELIteratingSMILESReader(InputStream in, IChemObjectBuilder builder) {
